...
image:https://img.shields.io/badge/maven%20central-v2.15.0-blue.svg["Maven Central",link="https://search.maven.org/#search%7Cga%7C1%7Ca%3A%22quickfixj-spring-boot-starter-examples%22"]
...
To build the docker containers:
     ...
     mvn clean install -DskipDocker=false -DskipTests=true -Pdocker
